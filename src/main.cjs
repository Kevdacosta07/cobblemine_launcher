...
function wire(){
 ...
 handle('check-launcher-update',async()=>{idle();if(process.platform==='darwin')return shell.openExternal('https://github.com/Kevdacosta07/cobblemine_launcher/releases/latest');await openStartup();return null;});
